...
class Store(models.Model):
    ...
    woo_consumer_secret = models.CharField(max_length=255, blank=True, null=True, verbose_name="رمز مشتری ووکامرس (Consumer Secret)")
    ...
    wp_app_password = models.CharField(max_length=255, blank=True, null=True, verbose_name="رمز عبور برنامه (Application Password)")
    # ---------------------------------------------------------------

    openai_api_key = models.CharField(max_length=255, blank=True, null=True, verbose_name="کلید API هوش مصنوعی")
    bot_token = models.CharField(max_length=255, blank=True, null=True, verbose_name="توکن ربات پیام‌رسان")
...
class ProductLog(models.Model):
    """سیستم لاگ‌گیری و گزارش‌گیری اختصاصی برای هر فروشگاه"""
    STATUS_CHOICES = (
        ('success', 'موفق'),
        ('failed', 'ناموفق'),
    )
